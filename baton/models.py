...
from sqlalchemy import Boolean, Date, DateTime, Double, ForeignKeyConstraint, Integer, PrimaryKeyConstraint, REAL, String, Text, UniqueConstraint, Uuid, text
...
class DoomsdayAttempt(Base):
    ...
    __table_args__ = (
        PrimaryKeyConstraint('id', name='doomsday_attempt_pkey'),
    )
    ...
    created: Mapped[Optional[datetime.datetime]] = mapped_column(DateTime, server_default=text('CURRENT_TIMESTAMP'))


class FantasyPositions(Base):
    __tablename__ = 'fantasy_positions'
    __table_args__ = (
        PrimaryKeyConstraint('id', name='fantasy_positions_pkey'),
    )
...
class FantasyPremUpdates(Base):
    ...
    __table_args__ = (
        PrimaryKeyConstraint('id', name='fantasy_prem_updates_pkey'),
    )

    id: Mapped[int] = mapped_column(Integer, primary_key=True)
    updated: Mapped[Optional[datetime.datetime]] = mapped_column(DateTime(True), server_default=text('CURRENT_TIMESTAMP'))
...
class FantasySeasons(Base):
    ...
    fantasy_players: Mapped[List['FantasyPlayers']] = relationship('FantasyPlayers', back_populates='season')
...
class FantasyTeams(Base):
    ...
    fantasy_players: Mapped[List['FantasyPlayers']] = relationship('FantasyPlayers', back_populates='fantasy_teams')


class MusicReviews(Base):
    __tablename__ = 'music_reviews'
    __table_args__ = (
        PrimaryKeyConstraint('id', name='music_reviews_pkey'),
    )
    ...
    created: Mapped[datetime.datetime] = mapped_column(DateTime(True), server_default=text('CURRENT_TIMESTAMP'))
...
class RedditSpurs(Base):
    ...
    __table_args__ = (
        PrimaryKeyConstraint('id', name='reddit_spurs_pkey'),
    )
...
class VivinoGrapes(Base):
    ...
    __table_args__ = (
        PrimaryKeyConstraint('id', name='vivino_grapes_pkey'),
    )

    id: Mapped[int] = mapped_column(Integer, primary_key=True)
    name: Mapped[str] = mapped_column(String(255))

    vivino_countries: Mapped[List['VivinoCountries']] = relationship('VivinoCountries', foreign_keys='[VivinoCountries.grape1_id]', back_populates='grape1')
    vivino_countries_: Mapped[List['VivinoCountries']] = relationship('VivinoCountries', foreign_keys='[VivinoCountries.grape2_id]', back_populates='grape2')
    vivino_countries1: Mapped[List['VivinoCountries']] = relationship('VivinoCountries', foreign_keys='[VivinoCountries.grape3_id]', back_populates='grape3')


class VivinoWineries(Base):
    __tablename__ = 'vivino_wineries'
    __table_args__ = (
        PrimaryKeyConstraint('id', name='vivino_wineries_pkey'),
    )

    id: Mapped[int] = mapped_column(Integer, primary_key=True)
    name: Mapped[str] = mapped_column(String(255))

    vivino_wines: Mapped[List['VivinoWines']] = relationship('VivinoWines', back_populates='winery')


class FantasyPlayers(Base):
    __tablename__ = 'fantasy_players'
    __table_args__ = (
        ForeignKeyConstraint(['element_type'], ['fantasy_positions.id'], name='fantasy_players_element_type_fkey'),
        ForeignKeyConstraint(['season_id'], ['fantasy_seasons.id'], name='fantasy_players_season_fkey'),
        ForeignKeyConstraint(['team'], ['fantasy_teams.id'], name='fantasy_players_team_fkey'),
    ...
    season: Mapped[Optional['FantasySeasons']] = relationship('FantasySeasons', back_populates='fantasy_players')
...
class Matches(Base):
    ...
    __table_args__ = (
        ForeignKeyConstraint(['away_team_id'], ['teams.id'], name='matches_away_team_id_fkey'),
        ForeignKeyConstraint(['home_team_id'], ['teams.id'], name='matches_home_team_id_fkey'),
    ...
    match_updates: Mapped[List['MatchUpdates']] = relationship('MatchUpdates', back_populates='match')


class VivinoCountries(Base):
    __tablename__ = 'vivino_countries'
    __table_args__ = (
        ForeignKeyConstraint(['grape1_id'], ['vivino_grapes.id'], name='vivino_countries_grape1_id_fkey'),
        ForeignKeyConstraint(['grape2_id'], ['vivino_grapes.id'], name='vivino_countries_grape2_id_fkey'),
        ForeignKeyConstraint(['grape3_id'], ['vivino_grapes.id'], name='vivino_countries_grape3_id_fkey'),
    ...
    grape1: Mapped[Optional['VivinoGrapes']] = relationship('VivinoGrapes', foreign_keys=[grape1_id], back_populates='vivino_countries')
...
class MatchUpdates(Base):
    ...
    __table_args__ = (
        ForeignKeyConstraint(['match_id'], ['matches.id'], name='match_updates_match_id_fkey'),
    ...
    match: Mapped[Optional['Matches']] = relationship('Matches', back_populates='match_updates')


class VivinoRegions(Base):
    __tablename__ = 'vivino_regions'
    __table_args__ = (
        ForeignKeyConstraint(['country_code'], ['vivino_countries.code'], name='vivino_regions_country_code_fkey'),
    ...
    vivino_countries: Mapped['VivinoCountries'] = relationship('VivinoCountries', back_populates='vivino_regions')
    vivino_wines: Mapped[List['VivinoWines']] = relationship('VivinoWines', back_populates='region')


class VivinoWines(Base):
    __tablename__ = 'vivino_wines'
    __table_args__ = (
        ForeignKeyConstraint(['region_id'], ['vivino_regions.id'], name='vivino_wines_region_id_fkey'),
        ForeignKeyConstraint(['winery_id'], ['vivino_wineries.id'], name='vivino_wines_winery_id_fkey'),
    ...
    region: Mapped['VivinoRegions'] = relationship('VivinoRegions', back_populates='vivino_wines')
    winery: Mapped['VivinoWineries'] = relationship('VivinoWineries', back_populates='vivino_wines')
    wine_quiz: Mapped[List['WineQuiz']] = relationship('WineQuiz', back_populates='wine')


class WineQuiz(Base):
    __tablename__ = 'wine_quiz'
    __table_args__ = (
        ForeignKeyConstraint(['wine_id'], ['vivino_wines.id'], name='wine_quiz_wine_id_fkey'),
    ...
    wine: Mapped['VivinoWines'] = relationship('VivinoWines', back_populates='wine_quiz')
